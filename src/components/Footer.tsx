...
const Footer = () => {
    return (
        <footer className="bg-gray-800 text-white py-16 flex flex-col items-center gap-12 md:flex-row md:justify-between lg:px-32 px-8">
            <div className="flex flex-col md:flex-row gap-5 md:gap-20">
                <div className="space-y-10 flex flex-col items-center md:items-start mb-8 md:mb-0">
                    <img src="/logo2.svg" alt="Logo"/>
                    <div className="flex gap-5">
                        <a href="#" target="_blank" rel="noopener noreferrer" className="transition duration-300 ease-in-out transform text-white hover:text-Lime-Green">
                ...
                <ul className="space-y-5 flex flex-col items-center md:items-start">
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">About Us</a></li>
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">Contact</a></li>
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">Blog</a></li>
                </ul>

                <ul className="space-y-5 flex flex-col items-center md:items-start">
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">Careers</a></li>
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">Support</a></li>
                    <li><a href="#about" className="text-Grayish-Blue font-PublicSans hover:text-Lime-Green">Privacy Policy</a></li>
                </ul>
