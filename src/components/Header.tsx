...
const Header = () => {
    return (
        <header className="relative grid grid-cols-12 pl-32 max-w-full h-[750px]">
            {/* Columna izquierda */}
            <div className="col-span-5 flex flex-col justify-center z-10">
                ...
                <button className="bg-gradient-to-r from-Lime-Green to-Bright-Cyan text-white px-8 py-3 rounded-full font-PublicSans self-start">Request Invite</button>
            </div>
            {/* Columna derecha (imagen JPEG con fondo SVG) */}
            <div className="col-span-7 relative">
                <div className="absolute top-0 right-0 bottom-0 -left-32 bg-center bg-no-repeat" style={{ backgroundImage: 'url(/bg-intro-desktop.svg)', backgroundSize: '1000px 1000px', backgroundPosition: '400px -145px' }}>
